      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {results.map((result, index) => (
            <AnimatedSection key={result.id} animation="scale" delay={index * 100}>
              <Card className="bg-white dark:bg-gray-800 shadow-xl border-0 hover:shadow-2xl transition-all duration-300 hover:scale-105">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="absolute left-4 top-1/2 transform -translate-y-1/2 rounded-full w-12 h-12 p-0 bg-white/90 dark:bg-gray-800/90"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="absolute right-4 top-1/2 transform -translate-y-1/2 rounded-full w-12 h-12 p-0 bg-white/90 dark:bg-gray-800/90"
          >
